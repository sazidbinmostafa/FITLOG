...
function Banner() {
    return (
        <div className='bg-[#15171D] container py-14 my-14 rounded-2xl flex flex-col-reverse md:flex-row justify-around items-center gap-10'>
            <div className='space-y-4 text-center md:text-left'>
                ...
                <button className='btn bg-[#C2F800] text-black hover:bg-[#A8D500] focus:bg-[#A8D500] active:bg-[#A8D500] uppercase font-bold'>Browse Workouts</button>
            </div>
            <div>
